...
public class StatementTemplate {
    ...
    public ResultSet query(Query query) throws SQLException {
        return execute(query, PreparedStatement::executeQuery);
    }
     ...
     */
    private <T> T execute(Query query, PreparedStatementCallback<T> preparedStatementCallback) throws SQLException {
     ...
     *                      query
     */
    private PreparedStatement prepareStatement(final Query query) throws SQLException {
        return execute(connection -> {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(sqlToRun);
